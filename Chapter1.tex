...
\begin{figure}[h]
	...
	\caption[Ejemplos de estructuras de \textit{Flavivirus} en PDB]{A)Proteínas estructurales y modelo de ensamble del complejo C-M-E. B)Proteínas no estructurales}
	\label{proteinasflav}
\end{figure}

\subsection{Ciclo de replicación}

El tamaño y forma de los virus tiene implicaciones en su ciclo de replicación. En el caso de los \textit{Flavivirus}, la primera etapa después de la transmisión por el vector consiste en la \textbf{adhesión y entrada}, etapa en donde se tienen interacciones importantes con dos clases de proteínas que se encuentran en la superficie celular objetivo, las primeras conocidas como factores de adhesión son aquellas que ayudan a aumentar la unión a la superficie celular, estos pueden ser proteínas que se unan a componentes de la membrana del virión como fosfatidilserina o a otras moléculas como pueden ser los azúcares presentes en las glicosilaciones de la proteína, los segundos los verdaderos receptores, son proteínas que se encargan de la internalización del virión de los cuales para el caso de \ac{DENV} y \ac{ZIKV} se han propuesto algunos posibles receptores pero no se ha determinado uno en concreto. \cite{Racaniello2020,Carro2020,Kaufmann2011,Pierson2020}. Seguido a la unión con receptor ocurre una \textbf{internalización} conocida como endocitosis que en algunos casos es mediada por otras proteínas como clatrina y provocar la formación del endosoma que contiene al virión junto con los componentes de la membrana del hospedero, posterior a esto, mediante un cambio de reducción en el pH ocurre una transición que promueve la exposición del péptido de fusión que se inserta en la membrana del endosoma y esto promueve la liberación del material genético para su replicación. \cite{Pierson2020} Después del desensamblaje del virión siguen las etapas de \textbf{traducción, replicación y ensamblaje} etapas que ocurren en el citoplasma y el \ac{RE} que culminan con la producción de viriones inmaduros que aún cuentan con la presencia de la proteína \ac{pr}.\cite{Racaniello2020,Pierson2020} Una vez ensamblado el virión es necesario su paso por el Golgi en donde hay un descenso en el pH y mediante su interacción con la proteína furina del hospedero que se encarga de escindir la proteína \ac{prM} siendo esta etapa la etapa crucial para la \textbf{maduración} del virión y su posterior salida de la célula del hospedero.\cite{Pierson2020}
...
\ac{ZIKV}
\section{Técnicas utilizadas para el tratamiento}
\subsection{Dificultades en el diseño de posibles tratamientos}
Aunque uno puede estar adecuado a las imágenes y estructuras de los \textit{Flavivirus} donde se muestra una estructura empaquetada con las proteínas E sobre la superficie de la membrana viral, la realidad es que el virión no solo es dependiente del pH para mostrar cambios conformacionales, si no que también es dependiente de la temperatura y esta dependencia puede causar que los epítopos queden parcial o totalmente ocultos, cosa que ha sido reportada para el caso del \ac{DENV}2 donde ante temperaturas mayores existe un tipo de expansión en el virión como lo muestra la figura \ref{temp_ph} que muestra los cambios que pueden existir en la morfología del virión.\cite{REY2013,Yu2008}
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Figure/temp_ph}
	\caption[Factores que afectan a la morfología del virión]{A)Ensamble del virus del Dengue serotipo 2 a temperaturas del vector 28 °C y del hospedero 34 °C. B)Ensamble del virus del Dengue a distintos valores de pH. }
	\label{temp_ph}
    \end{figure}
