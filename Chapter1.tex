...
Las funciones de las \ac{NS} son muy diversas desde la activación de la ruta NF-$\kappa$B o el inflamasoma y por eso solo se harán un breve resumen de sus funciones. Las proteínas \ac{NS} de los \textit{Flavivirus} son en su mayoría proteasas, como lo muestra la figura \ref{Poliprot} algunas proteínas sirven como proteasas de la poliproteína. La proteína \ac{NS}1 es abundante en el suero de pacientes infectados, es multifuncional se puede encontrar como monómero en el \ac{RE} en la replicación o como oligómero en otras etapas de la infección.\cite{VanLeur2021,Latanova2022}
