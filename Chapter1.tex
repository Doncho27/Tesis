...
\begin{figure}[H]
	...
	\caption{A) Clasificaciones propuestas por Baltimore. B) Visualización de la clasificación de Baltimore en unión con la clasificación Taxonómica (Imagenes modificadas)}
